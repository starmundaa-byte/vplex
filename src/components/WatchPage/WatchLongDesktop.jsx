...
const WatchLongDesktop = ({ video, related, navigate }) => {
    ...
    <div className="watch-desktop">
      ...
      <div className="left-section">
        ...
        <div className="video-info">
          ...
          {/* ONE SINGLE ROW: Channel + Actions */}
          <div className="channel-row" style={{ flexWrap: "nowrap" }}>
            {/* Channel + Subscribe */}
            <div
              style={{
                display: "flex",
            ...
            >
              ...
              <div className="channel-info">
                ...
                <span style={{ fontSize: "13px", color: "#aaa", marginTop: "2px" }}>
                  120K subscribers
                </span>
              </div>
              <button
...
export default WatchLongDesktop;
